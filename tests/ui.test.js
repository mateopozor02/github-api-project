...
describe("displayRepos functions", () => {
    ...
    repositories = [
      {
        ...
        updated_at: "2021-06-14T13:35:00Z",
      },
      {
        name: "repo2",
        stargazers_count: 50,
        updated_at: "2022-05-14T13:35:00Z",
      },
      {
        name: "repo3",
        stargazers_count: 150,
        updated_at: "2023-03-14T13:35:00Z",
      },
    ];
  ...
  test("displayStarredRepos adds the repos with more than 5 stars to the DOM", () => {
    ...
    filterStarredRepos.mockReturnValue([
      repositories[0],
      repositories[1],
      repositories[2],
    ]);
  ...
  test("displayRecentRepos adds the recent repos to the DOM", () => {
    ...
    sortByLastUpdated.mockReturnValue([
      repositories[2],
      repositories[1],
      repositories[0],
    ]);
